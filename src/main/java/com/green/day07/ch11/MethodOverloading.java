...
public class MethodOverloading {
    ...
    public void MethodOverloading() {} // 밑에 생성자가 있어서 기본 생성자를 만들어주지 않음.
    ...
    // public  String sum(int n1, int n2){} // 리턴 타입으로는 구분하지 않는다.
...
class Test {
    public static void main(String[] args) {
        ...
        // public void MethodOverloading() {} 에서 void 를 지워서 메소드 해제하면 기본 생성자 생겨서 가능
    }
}
