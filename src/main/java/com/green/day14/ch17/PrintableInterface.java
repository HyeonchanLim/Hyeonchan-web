...
/*
    ...
    게임에서 화면에 나오는 버튼이랑 hp , mp 같이 보이는 부분을 인터페이스라고 한다.
...
//public static final int NUM = 0;  // 멤버필드 앞에는 public static final 이 무조건 추가
//public abstract void print(String doc); // 메소드 앞에는 public abstract 가 무조건 추가

interface Printable {
    int NUM = 0; // 초기화를 무조건 해야함 int num; 은 불가능
    void print(String doc);
}

// 클래스를 implements 했다는걸 남기기 위해서 클래스명 + Impl 라고 작성한다.
