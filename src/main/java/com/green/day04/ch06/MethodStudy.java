...
public class MethodStudy {
    ...
    // void메소드 , return메소드 에서 같은 메소드 이름은 사용가능하지만 파라미터가 같으면 불러올 수 없다.
    // 파라미터의 갯수나 타입이 다르면 같은 메소드 이름을 써도 괜찮다 - 전문용어로 오버로딩 이라고 부른다.
    // 같은 이름을 가진 메서드지만 매개변수가 다르기 때문에 사용 가능 - 파라미터
